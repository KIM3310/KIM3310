...
There are many excellent but adjacent "workbench" repos. A technical evaluator, customer, or collaborator will understand the body of work faster if the profile README and portfolio site present them as a curated system map:
...
Paths worth renaming or documenting because they can alarm security teams:
