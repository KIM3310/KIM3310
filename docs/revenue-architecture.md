...
| Layer | Decision |
| --- | --- |
| Target buyer / user | founder, operator, or engineering team looking for deployable AI/system templates instead of generic demos |
| Productized offer | systems catalog that routes visitors to runnable demos, architecture packs, and productized service templates |
| First paid SKU | paid implementation package, architecture adaptation package, or template bundle attached to selected systems |
| Free lead magnet | public architecture index with free system diagrams and deployment notes |
| Paid expansion | fixed-price implementation sprints and paid private adaptation of selected repositories |
| Data / workflow moat | cross-repository architecture map, demo routes, deployment notes, and reusable proof assets |
| Private inquiry | https://kim3310-doeon-kim-portfolio.pages.dev/?offer=KIM3310&inquiry=architecture-scope-sprint#private-inquiry |
...
| Repo-specific launch path | GitHub Pages or Cloudflare Pages as storefront, Workers lead capture, Supabase CRM table, R2 for downloadable packs |
...
2. Route confidential and commercial requests through the [central Cloudflare D1 private inquiry](https://kim3310-doeon-kim-portfolio.pages.dev/?offer=KIM3310&inquiry=architecture-scope-sprint#private-inquiry); keep public GitHub issues limited to non-confidential product discussion.
