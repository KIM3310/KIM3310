...
| Field | Decision |
|---|---|
| Service type | GitHub profile router |
| Primary reader or buyer | Technical evaluators and buyers entering through the GitHub account. |
| Wedge | Use profile to route to the portfolio and top service architectures. |
