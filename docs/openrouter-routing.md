...
| Lane | Model | Purpose |
|---|---|---|
| Primary | `openrouter/auto` | Profile-level repository guide and architecture index assistant. |
...
OPENROUTER_HTTP_REFERER=https://github.com/KIM3310
OPENROUTER_APP_TITLE=KIM3310
```
